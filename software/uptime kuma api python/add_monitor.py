...
# result = api.add_monitor( type=MonitorType.DOCKER, name="Google", docker_host=1, docker_container="sonarr") # dokcer container
result = api.add_monitor( type=MonitorType.HTTP, name="Google", docker_host="", docker_container="", url="https://www.google.co.za") # http 
